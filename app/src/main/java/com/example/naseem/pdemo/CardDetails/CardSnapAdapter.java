...
public class CardSnapAdapter extends RecyclerView.Adapter<CardSnapAdapter.ViewHolder> implements GravitySnapHelper.SnapListener {

    public static final int VERTICAL=0;
    public static final int HORIZONTAL=1;
    private ArrayList<CardSnap> mSnaps;
    ...
    public CardSnapAdapter(){
        mSnaps=new ArrayList<>();

    }
    public void addSnap(CardSnap snap){
        mSnaps.add(snap);
    }
    ...
    public int getItemViewType(int position){
        CardSnap snap=mSnaps.get(position);
