...
import thinkbiz.solutions.tbs.com.CategoryItems.GridAdapter;
import thinkbiz.solutions.tbs.com.CategoryItems.GridModel;
...
public class KeyWordSearchActivity extends AppCompatActivity {
    ...
    private void parseJSON() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, AllUrls.SEARCH_KEYWORD+pname,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mExampleAdapter = new GridAdapter(KeyWordSearchActivity.this, mExampleList);
        ...
        mRequestQueue = Volley.newRequestQueue(KeyWordSearchActivity.this);
